...
<html lang="en">
    <head>
        ...
        <title>Upload an avatar - iLibrarium</title>
    ...
    <body>
        ...
        <div class="container-fluid">
            ...
            <div class="col-sm-6">         
                ...
                <?php
                #same algorith as image upload, w/o thumbnails and carousel
                if (isset($_FILES['file']['tmp_name']) && !empty($_FILES['file']['tmp_name'])) {
                    $file = $_FILES['file'];

                    #read text from form
                    $author = clean(filter_input(INPUT_POST, 'author', FILTER_SANITIZE_STRING));
                    if (empty($author)) {
                    ...
                    $avatar = new Avatar($file, $author, $description);
                    if (!empty($alert)) {
                        #<!-- Alert -->
                        ...
                        echo '<p><a href="avatar_upload.php">Upload next avatar</a></p>';

                    }
                }

                if (!isset($_POST['author']) || !empty($alert)) {
                # text and form
                ?>
                <h2>Upload an avatar</h2>
                <p>Allowed filetypes are JPG, GIF, and PNG.<br>
                Max filesize is 1Mb.<br>
                Max avatar dimensions are 50 x 50 pixels.<br></p>
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form enctype="multipart/form-data" action="avatar_upload.php" method="post" id="newavatarform">
                            <div class="form-group">
                                <label class="control-label" for="file">Please select a file to upload</label>
                                <input type="file" class="form-control-file" id="file" name="file">
                            </div>
                            <div class="form-group <?php if (empty($author) && isset($_POST['author'])) { echo 'has-error';} ?>">
                            ...
                            <div class="form-group <?php if (empty($description) && isset($_POST['description'])) { echo 'has-error';} ?>">
