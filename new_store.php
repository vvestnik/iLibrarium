...
#only for Regional managers
$_SESSION['aut_user']->checkRole(new Role('name', 'Regional-manager'));
$alert = '';
$name = '';
$address = '';
?>
...
<html lang="en">
    <head>
        ...
        <title>Add a new Store - iLibrarium</title>
        ...
        <div class="container-fluid">
            ...
            <div class="col-sm-6">
                ...
                if (isset($_POST['name'])) {
                    ...
                    if (empty($address)) {
                        $alert .= 'Please enter the address<br>';
                    }
                    if (!empty($alert)) {
                        #<!-- Alert -->
                        ...
                        echo '<h2>Store added.</h2>';
                        echo '<h3>Added information</h3>';
                        echo '<p><b>Name:</b><br>' . $store->getName() . '<br>';
                        echo '<b>Address:</b><br>' . $store->getAddress() . '<br>';
                ...
                if (!isset($_POST['name']) || !empty($alert)) {
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <form action="new_store.php" method="post" id="newstoreform">
                                ...
                                <div class="form-group <?php 
                                    ...
                                    <input type="text" value="<?php echo $address; ?>" class="form-control" id="address" name="address" placeholder="Address">
                                </div>                                  
